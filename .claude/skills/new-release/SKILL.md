...
`ghcr.io/sandersono/robo-multipost:X.Y.Z` e `:latest`.
...
gh release create vX.Y.Z \
  -R Sandersono/robo-multipost \
  --title "vX.Y.Z: <descricao curta>" \
  --latest \
  --notes-file /tmp/release-notes.md
```

IMPORTANTE: Sempre usar `-R Sandersono/robo-multipost` (o `gh` pode apontar para o upstream).
...
package.json:    X.Y.Z
version.txt:     X.Y.Z
GitHub Release:  https://github.com/Sandersono/robo-multipost/releases/tag/vX.Y.Z

CI/CD:
  GitHub Actions: https://github.com/Sandersono/robo-multipost/actions
  Imagem Docker:  ghcr.io/sandersono/robo-multipost:X.Y.Z + :latest

Para atualizar na VPS:
  docker pull ghcr.io/sandersono/robo-multipost:X.Y.Z
...
apenas como `ghcr.io/sandersono/robo-multipost:X.Y.Z-rc.N`.
...
>
> ```bash
> docker pull ghcr.io/sandersono/robo-multipost:X.Y.Z-rc.N
> ```
```
...
GitHub Release:  https://github.com/Sandersono/robo-multipost/releases/tag/vX.Y.Z-rc.N (pre-release)

CI/CD:
  GitHub Actions: https://github.com/Sandersono/robo-multipost/actions
  Imagem Docker:  ghcr.io/sandersono/robo-multipost:X.Y.Z-rc.N
...
CI/CD:
  Promote:        https://github.com/Sandersono/robo-multipost/actions (re-tag sem rebuild)
...
- A imagem Docker NAO tem prefixo v (ex: ghcr.io/sandersono/robo-multipost:0.3.0)
