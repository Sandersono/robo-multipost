...
tools: Read, Glob, Grep, Bash(gh api repos/Sandersono/robo-multipost/dependabot/alerts:*)
model: sonnet
---
...
- **MUST NOT** run `Write`, `Edit`, MCP tools, tests, lints,
  ...
  repos/Sandersono/robo-multipost/dependabot/alerts` described in
...
```
gh api repos/Sandersono/robo-multipost/dependabot/alerts --paginate \
